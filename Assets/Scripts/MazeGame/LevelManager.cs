...
namespace mazeGame
{
    public class LevelManager : MonoBehaviour
    {
        ...
        public void NextPattern()
        {
            ...
            currentPatternTrans.localScale = new Vector3(currentPatternTrans.localScale.x + scaleInc,
                currentPatternTrans.localScale.y + scaleInc, currentPatternTrans.localScale.z + scaleInc);
